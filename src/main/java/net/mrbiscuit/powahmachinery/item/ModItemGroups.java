...
public class ModItemGroups {
    public static final ItemGroup PowahMachineryGroup = Registry.register(Registries.ITEM_GROUP,
            ...
            FabricItemGroup.builder().displayName(Text.translatable("itemgroup.powahmachinery"))
                    .icon(() -> new ItemStack(ModBlocks.Powered_Furnace)).entries((displayContext, entries) -> entries.add(ModBlocks.Powered_Furnace)).build());
